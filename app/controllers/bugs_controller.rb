class BugsController < ApplicationController
    before_action :set_bug, :set_status_options, :set_issue_type_options, :set_priority_options, only: [:show, :edit, :update, :destroy]
    ...
    def set_status_options
      @status_options = Bug.status_options
    end
    
    def set_issue_type_options
      @issue_type_options = Bug.issue_type_options
    end
    
    def set_priority_options
      @priority_options = Bug.priority_options
    end
